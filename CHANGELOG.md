...
- **Установка и смена пароля в кабинете** — если забыли пароль, войдите по коду из письма, затем в кабинете нажмите «Установить пароль» и задайте постоянный (8–128 символов). Повторно та же кнопка меняется на «Сменить пароль». Подписки и платежи не затрагиваются — это чисто техническая возможность для входа.
