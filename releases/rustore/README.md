...
| ---------- | ------ | ------------- | ----------- | ------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------- |
| 2026-05-16 | child  | 0.51.1 (6089) | 6089        | 2063713899         | ⏳ К подаче (task #68 — fix регрессии latency push: FcmTokenRefreshWorker periodic 6h, native onNewToken POST, backend forceFcmRefresh флаг). Smoke-test пройден на POCO 25028PC03G через adb install -r. | cc65223cfb4f4ae4056ad49e94b2bde934bedf0817d6a66214756be747274f5f |
