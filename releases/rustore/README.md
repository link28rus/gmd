...
| ---------- | ------ | ------------- | ----------- | ------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------- |
| 2026-05-17 | child  | 0.51.2 (6090) | 6090        | 2063713899         | ⏳ Ожидает модерацию. Rebrand «GMD Ребёнок» → «Перископ Ребёнка»: новый android:label, AppBar header «Перископ», brand-иллюстрация на onboarding (assets/images/onboarding_hero.png), пустое поле ввода кода (убран hint), имя семьи на home («Ты подключён к семье «<имя>»» через расширенный /child/me). Smoke-test пройден на AVD x86_64 + POCO X7 Pro / HyperOS 15. Backend задеплоен на прод. Submit через Playwright wizard 2026-05-17 ~14:25 MSK. | c4475fca4562d1d0f01e0f84b01a7163c03bc4cd9d50da8654ae5b73ca96f211 |
