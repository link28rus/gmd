...
| ---------- | ------ | ------------- | ----------- | ---------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------- |
| 2026-07-03 | child  | 0.52.0 (6091) | 6091        | pro.periscop.child (новая запись)  | 🆕 Проход B — новый package `pro.periscop.child`, полная вычистка GMD (namespace, класс a11y, SharedPrefs/WorkManager/notif-каналы, log-теги, User-Agent, MethodChannel, sqlite), новая фирменная иконка. AVD smoke x86_64 пройден (child «Привет! Это Перископ», без крашей), aapt badging `pro.periscop.child` / label «Перископ Ребёнка», ноль gmd в манифесте. **Первый upload — ТОЛЬКО вручную через Console** (Public API не создаёт/не сидит новые записи, браузерный upload капнут 10 МБ). Файл: `releases/rustore/child/periscop-child-0.52.0+6091.aab`.                                                                                                                                                                                              | 872d50d3303812d013d1898bf8d1c09f5ab7ac3cf3be3b2b09f36263fc49c294 |
| 2026-07-03 | parent | 0.52.0 (27)   | 27          | pro.periscop.parent (новая запись) | 🆕 Проход B — новый package `pro.periscop.parent`, вычистка GMD (namespace, WebView JS-bridge, FCM-каналы, DiagLog), новая фирменная иконка. AVD smoke пройден (parent «Вход в Перископ», без крашей), label «Перископ Родителя», ноль gmd в манифесте. **Первый upload — ТОЛЬКО вручную через Console.** Файл: `releases/rustore/parent/periscop-parent-0.52.0+27.aab`.                                                                                                                                                                                                                                                                                                                                                                                       | 3c41c3b0c55b4c139539b949a2f0f58f4873886156378a8675156f15b1eb7c0a |
