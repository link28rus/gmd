...
// Скрытый диагностический экран — последние события Dart-side / native.
// Открывается долгим нажатием на версию в хедере /home. Нужен чтобы снимать
// диагностику без ADB: пользователь делает скриншот — этого хватает.
