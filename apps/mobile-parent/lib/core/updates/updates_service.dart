...
/// Auto-update mobile-parent — сервис проверки и скачивания обновлений.
///
...
class UpdatesService {
  ...
  String _latestUrl(String abi) =>
      '$apiBaseUrl/public/updates/mobile-parent/latest?abi=$abi';
  ...
  /// Возвращает UpdateInfo если есть НОВЕЕ текущей, null иначе.
  /// Никогда не throw — auto-update не должен ломать app старт.
