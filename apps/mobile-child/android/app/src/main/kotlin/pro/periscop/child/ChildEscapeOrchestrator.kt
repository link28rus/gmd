 ...
 *       - DiagLog (для аудита)
 *       - Snapshot SharedPreferences flag `periscop_escape_mode = true` (UI читает)
...
object ChildEscapeOrchestrator {
  ...
  private const val PREFS = "periscop_escape"
  ...
  fun probe(ctx: Context): ProbeResult {
    ...
    return try {
      ...
      conn = (url.openConnection() as HttpURLConnection).apply {
        ...
        setRequestProperty("User-Agent", "periscop-child-escape/0.38")
      }
