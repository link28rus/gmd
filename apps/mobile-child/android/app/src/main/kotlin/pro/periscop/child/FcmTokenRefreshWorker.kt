 ...
 * (sync через `Tasks.await`), сравнивает с last-saved в `periscop_fcm` SharedPreferences,
...
class FcmTokenRefreshWorker(
    ...
    companion object {
        ...
        const val UNIQUE_NAME = "periscop_fcm_token_refresh_periodic"

        private const val PREFS = "periscop_fcm"
