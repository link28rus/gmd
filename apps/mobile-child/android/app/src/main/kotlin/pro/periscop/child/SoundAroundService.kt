...
class SoundAroundService : Service() {
    ...
    companion object {
        ...
        private const val NOTIFICATION_CHANNEL_ID = "periscop_sound_around"
        ...
        const val ACTION_STOP = "pro.periscop.child.ACTION_SOUND_AROUND_STOP"
        private const val WAKE_LOCK_TAG = "periscop:SoundAroundService"
