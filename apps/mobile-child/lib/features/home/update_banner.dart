...
/// Auto-update — баннер на home_screen. После перехода на RuStore SDK
/// (lesson #24) сам процесс update'а — модальный SDK-экран RuStore, баннер
/// нужен только для UpdateFailed: если SDK threw — показываем кнопку
/// «Повторить». Idle / Checking / NotNeeded — пустой SizedBox.shrink().
