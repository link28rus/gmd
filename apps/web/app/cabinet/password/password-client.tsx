  ...
  return (
    <div className="mx-auto max-w-md p-6">
      ...
      <div className="rounded-lg border border-zinc-200 bg-white p-8 shadow-sm">
        <h1 className="mb-1 text-2xl font-semibold text-zinc-900">{title}</h1>
        <p className="mb-6 text-sm text-zinc-600">{subtitle}</p>
        <form onSubmit={onSubmit} className="space-y-4">
          <div>
            <label htmlFor="pwd" className="mb-1 block text-sm font-medium text-zinc-700">
              Новый пароль
            </label>
            <input
              id="pwd"
              ...
              disabled={submitting}
              className="w-full rounded-md border border-zinc-300 bg-white px-3 py-2 text-sm text-zinc-900 focus:border-zinc-900 focus:outline-none disabled:bg-zinc-100"
              required
            />
          ...
          <div>
            <label htmlFor="pwd2" className="mb-1 block text-sm font-medium text-zinc-700">
              Подтвердите пароль
            </label>
            <input
              id="pwd2"
