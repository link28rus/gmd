...
// Пресеты длительности (минуты). Соответствуют дизайну «Где мои дети»
// — 5 мин для быстрой паузы, до 24 ч для «на всю ночь / выходные».
// Backend принимает любой int в [5, 1440] — пресеты лишь для UX.
